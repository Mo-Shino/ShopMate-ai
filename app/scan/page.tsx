...
export default function ScanPage() {
    ...
    return (
        <div className="h-full flex flex-col p-6 relative overflow-hidden bg-bg-cream font-fredoka">
            ...
            {/* Header */}
            <PageHeader title="Scan Item" icon={Scan} className="mb-4" />
            ...
            <div className="flex-1 w-full flex flex-col items-center z-10">
                <div className="flex flex-col items-center mb-4">
                    <p className="text-primary-brown/60 text-lg text-center max-w-md">
                        Point your camera at a product barcode to verify price and add to your shopping list.
                    </p>
                </div>

                {/* Camera Viewfinder Area */}
                <div className="relative w-full max-w-2xl flex-1 max-h-[50vh] min-h-[300px] bg-black rounded-[2.5rem] overflow-hidden border-[6px] border-white shadow-2xl group">
                    {/* The Camera Feed */}
                ...
                <button
                    ...
                    className="mt-8 flex items-center gap-2 px-4 py-2 bg-white/50 hover:bg-white rounded-full text-primary-brown/50 hover:text-primary-brown transition-all text-sm font-medium border border-transparent hover:border-primary-brown/10"
                >
                    <Zap size={16} />
